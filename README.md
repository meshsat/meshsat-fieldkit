...
| V2 | [`v2/BUILD.md`](v2/BUILD.md) | ordering the six boards at JLCPCB with the exact settings, everything else to buy, case and frame preparation, the BB-2590/U pack, the assembly order with torques, leads and pigtails, coating and labels, software bring-up, the open items of this generation |
