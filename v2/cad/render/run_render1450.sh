...
cp $R/v2/release/revA/case/face-plate/face-plate.stl $H/stl/face_plate.stl 2>/dev/null && echo "plate STL copied"
cp $R/v2/release/revA/case/lid-bracket-qmx/lid-bracket-qmx.stl $H/stl/lid_bracket_qmx.stl 2>/dev/null && echo "lid bracket STL copied"   # C7 face plate v2 (7 Sep 2026): the STL from v2/cad/face_plate.py, not a STEP conversion
