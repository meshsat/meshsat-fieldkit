...
Enclosure: printed, two parts, 2.5 mm walls, outer 81 x 220 x 26, cavity 76 x 215 x 21 with the cells against the north end and
...
W, L, H = 81.0, 220.0, 26.0          # enclosure outer
T = 2.5                               # wall and floor
LID = 2.5
CW, CL, CH = W - 2 * T, L - 2 * T, H - T - LID     # cavity 76 x 215 x 21
...
# pocket rib: a 2 mm rib across the cavity 16 mm from the south wall keeps the cells off the protection board
base += box(CW, 2.0, 8.0, T, T + POCKET[1] + 2.0, T)
