...
with PdfPages(out_fn) as pdf:
    ...
    fig.text(0.02, 0.012, "MeshSat field kit V2, Peli 1450 face plate, Rev A (C7), 7 Sep 2026, scale 1:2 on A3, all mm. Prototype drawing generated by v2/cad/plate_drawing.py from face-plate.dxf (layers OUTLINE, THROUGH, POCKET_1MM, STANDOFF_M3). Nothing built.", fontsize=7)
