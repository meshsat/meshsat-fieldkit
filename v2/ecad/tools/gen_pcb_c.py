...
for attr, val in (("m_MinClearance", 0.127), ("m_TrackMinWidth", 0.127), ("m_ViasMinSize", 0.4 if COPPER_LAYERS >= 4 else 0.5), ("m_MinThroughDrill", 0.2 if COPPER_LAYERS >= 4 else 0.3), ("m_HoleToHoleMin", 0.3), ("m_CopperEdgeClearance", 0.3), ("m_HoleClearance", 0.25), ("m_SolderMaskMinWidth", 0.1)):
