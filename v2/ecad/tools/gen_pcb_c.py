...
COPPER_LAYERS = 4; ds.SetCopperLayerCount(COPPER_LAYERS)   # C6 is a four-layer backer (6 Sep 2026 04:50): In1 a solid ground plane (the 5 Sep ruling for every board), In2 a routing layer; the two-layer backer left 14 to 23 connections open in every route of the quality programme's box, all in the driver cluster
