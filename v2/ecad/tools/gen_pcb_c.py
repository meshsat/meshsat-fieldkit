...
Every electrical part is placed by gen_pcb_c3.py from the netlist. Seals (owner rulings 5 Sep): 0.4 mm closed-cell foam tape frames under both lenses,
...
board = pcbnew.BOARD()
tb = pcbnew.TITLE_BLOCK(); tb.SetTitle("MeshSat Field Kit carrier - PCB-C CONTROL PANEL"); tb.SetRevision("A (C5)"); tb.SetDate("2026-09-05"); tb.SetCompany("MeshSat")
...
text("PCB-C UNDERSIDE (REV A, %s, MESHSAT-709, 2026-09-05) - sealed face: plugged vias, gasket band, silicone beads on the LED joints - faces PCB-B - ribbon J_PANEL (SMD), leads J_MAINSW / J_PIJ2 on solder lands" % PHASE, 0, -WIN_W / 2 + 9.0, pcbnew.B_SilkS, 2.0, 0.3, mirror=True)
