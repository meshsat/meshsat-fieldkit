...
part("BZ1", "Device", "Buzzer", "IP67 panel-mount sounder, 5 V DC continuous, bezel gasket on the face, two flying leads (part per docs/respin-research-seal-2026-09-04.md)", "BZ", {"1": "BZ_K", "2": "+5V"})
...
hdr += '\t(title_block (title "MeshSat Field Kit carrier - PCB-C CONTROL PANEL") (date "2026-09-04") (rev "A") (company "MeshSat") (comment 1 "Phase C5 schematic (sealed face: no through-hole connector, panel-mount sounder, masked frame rings), generated by tools/gen_sch_c.py. Netlist style: every pin carries a stub and a net label.") (comment 2 "MESHSAT-709. FE1.1s hub on internal regulators; TPS2065C x2 + TPS22810 x4 switches (B4: LoRa and RockBLOCK channels at 2 A for the T-Beam 1W and 9704 bursts); INA219 per channel; PCA9555 EN/FAULT; both Pi UARTs to the RockBLOCK site via JP3/JP4."))\n'
