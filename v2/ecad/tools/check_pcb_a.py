...
import verdict as _vh; _vh.crash_hook("check_pcb_a", sys.argv[1:])   # a crash in this module body writes INCONCLUSIVE, never nothing (18 Sep 2026)
...
EXPECT = {"J_DOCK": (-76, -70), "J_PRE1": (-103, -70), "J_CP1": (-99, -73), "J_CN4": (-87, -67), "F1": (-97, -52), "J_AB1": (113, -46), "J_MEZZ1": (-8, 8), "J_MEZZ_PWR1": (-8, -18),
          "U2": (-94, 56), "U3": (-96, 12), "U16": (-96, -26), "U4": (-60, 47), "U7": (-12, 47), "U13": (-44, 6), "U15": (-36, -27), "U18": (84.9, 29.1), "U1": (-49, -28), "U27": (-50, -19), "J_PA": (110, 62), "J_54V": (110, 0), "J_MAINSW": (98, 75)}
