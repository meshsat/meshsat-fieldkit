...
check(abs(x1 - x0 - 285) < 0.005 and abs(y1 - y0 - 160) < 0.005 and abs(x0 + 165) < 0.005 and abs(y1 - 80) < 0.005, "outline 285 x 160, X -165..120 (A15 pack extension)")
...
for ref, (ex, ey) in {"J_PACK": (-27, -8), "J_X1202BAT": (-27, 14), "F1": (-26, 33), "F2": (-8, 30), "J_DOCK": (-12, -70), "J_X1202DC": (-125, -60), "J_MEZZ1": (-8, 8), "J_GPS1": (30, -52), "J_WIFI1": (8, 52.5),
...
R = {"PACK": (-162, -37, -32, 37), "JPACK": (-31, -16, -23, 20), "MEZZ": (5, -31, 85, 31), "GPS": (50, -65, 90, -39), "WIFI": (20, 39.5, 105, 65.5), "HUB": (-104, 50, -30, 78), "PWR": (-104, -76, -60, -48),
...
for (ka, a), (kb, c) in itertools.combinations(R.items(), 2):
    if {ka, kb} in ({"HUB", "JWIFI"}, {"PWR", "JAB"}, {"PWR", "JLEDS"}): continue
