...
for ref, (ex, ey) in {"J_DOCK": (-122, -70), "J_PRE1": (-149, -70), "J_CP1": (-145, -73), "J_CN4": (-133, -67), "F3": (-150, -46), "F4": (-125, -46), "F5": (-100, -46), "F2": (-75, -46), "U22": (-148, -20), "U23": (-116, -20), "U24": (-86, -20), "U20": (-50, -58), "U21": (-112, -60), "R52": (-130, -60), "J_BM1": (-100, -66), "J_RF1": (-100, -56), "J_BM7": (96, -66), "J_RF7": (96, -56), "J_WALL1": (-156, 62), "U6": (-70, 52), "J_MEZZ1": (-8, 8), "J_GPS1": (30, -52), "J_WIFI1": (8, 52.5),
...
R = {"POWER": (-162, -40, -32, 2), "CTRL": (-162, 2, -118, 36), "DOCKBLK": (-152, -76, -112, -64), "MEZZ": (5, -31, 85, 31), "GPS": (50, -65, 90, -39), "WIFI": (20, 39.5, 105, 65.5), "HUB": (-104, 25, -30, 78), "CHG": (-70, -72, -30, -46),
...
for (ka, a), (kb, c) in itertools.combinations(R.items(), 2):
    if {ka, kb} in ({"HUB", "JWIFI"}, {"CHG", "JAB"}, {"CHG", "JLEDS"}, {"POWER", "DOCKBLK"}, {"GPS", "BM6"}, {"GPS", "BM7"}): continue
