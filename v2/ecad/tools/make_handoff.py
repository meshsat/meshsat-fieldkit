...
BOARDS = [  # (deliverable folder, file stem, project dir, title, phase, hand-fitted list)
    ("meshsat-pcb-a-revA-A16", "pcb-a-power", "pcb-a-power", "PCB-A POWER + I/O", "A16", "welded 1S8P pack strapped through the slots (XT60 to J_PACK), 15 A mini blade in F1 and 10 A mini blade in F2, 16 AWG lead from J_X1202BAT to the X1202 B+/B- holder tabs, 8 spring pins in J_DOCK (underside), XH lead from J_X1202DC to the X1202 barrel, GPS puck, WiFi dongle, PCB-D on its four M3 standoffs, harness ribbons"),
    ("meshsat-pcb-b-revA-B10", "pcb-b-compute", "pcb-b-compute", "PCB-B COMPUTE", "B10", "Pi 5 + X1202 stack, T-Call, T-Beam 1W, RTL-SDR / LimeSDR Mini, ZigBee dongle, RockBLOCK 9603 / 9704 with the GC bracket, Wio-SX1262, the 2x10 panel ribbon on J_PANEL"),
