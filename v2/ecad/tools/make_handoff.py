...
PCB_OPTIONS = {"pcb-b-compute": ["FABRICATION NOTES (B14, Compute Module 5 carrier with the M.2 WiFi socket, appendix 32.35 and 32.37)",
    ...
    "- Differential pairs: USB 2.0 pairs 0.20/0.15 mm (90 ohm), display DSI pairs 0.17/0.15 mm (100 ohm) on the JLC04161H-7628 stack; ask for impedance tuning of both if offered.",
    ...
    "pcb-c-display": ["FABRICATION OPTIONS (C5, sealed face)",
