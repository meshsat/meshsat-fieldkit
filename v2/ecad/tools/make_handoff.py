...
BOARDS = [  # (deliverable folder, file stem, project dir, title, phase, hand-fitted list)
    ("meshsat-pcb-a-revA-A18", "pcb-a-power", "pcb-a-power", "PCB-A POWER + I/O", "A18", "welded 1S8P pack strapped through the slots (XT60 to J_PACK), 15 A mini blades in F1 and F3 and a 10 A in F2, VH lead from J_5V_MOD1 to PCB-B J_5V_MOD (module rail), 16 AWG lead from J_X1202BAT to the X1202 B+/B- holder tabs, the Preci-Dip 813-S1-008-10-016101 spring-loaded connector in J_DOCK (underside, tails soldered on the top face), the boost inductor L2 (Coilcraft XAL6030-152MEB, no JLC equivalent, hand-soldered; left out of the JLC BOM/CPL), XH lead from J_X1202DC to the X1202 barrel, GPS puck, WiFi dongle, PCB-D on its four M3 standoffs, harness ribbons"),
    ("meshsat-pcb-b-revA-B12", "pcb-b-compute", "pcb-b-compute", "PCB-B COMPUTE", "B12", "Pi 5 alone on four M2.5 x 22 standoffs (Pi HDMI edge west, header edge east, SD card south; nothing under the X1202), XH sense lead from the X1202 5 V output to J_5V_IN1, T-Call, T-Beam 1W, RTL-SDR / LimeSDR Mini, ZigBee dongle, RockBLOCK 9603 / 9704 with the GC bracket, Wio-SX1262, the 2x10 panel ribbon on J_PANEL"),
    ("meshsat-pcb-c-revA-C4", "pcb-c-display", "pcb-c-display", "PCB-C CONTROL PANEL", "C4", "Touch Display 2 through the aperture on 0.05 mm transfer tape (3M 467MP / 9495LE), connector end to port; SW_MAIN C&K ATP19-SL1-603-B0SA-03G (19 mm, green ring), SW_PI C&K ATP16-SL1-403-M0SA-04G (16 mm, orange ring as the amber), SW_TEST C&K ATP16-SL1-203-M0SA-04G (16 mm, white ring), IP67 anti-vandal with flying leads to the four pads; SW_LIGHT NKK M2044SD3A01 DPDT ON-ON-ON toggle with the AT401A boot; SW_SOS and SW_ZERO NKK M2015SD3A01, SW_EMCON NKK M2012SD3A01 (S lever, D3 IP67 bushing, flying leads; no flip covers in Rev A, none is documented for a 1/4-40 bushing, ASSEMBLY.md section 9); WeAct 3.7 e-paper module under the panel: glass into the recessed window, both PCB lands taped (3M 9495LE), optional 1.0 mm spacer ring for a flush face, 2x4 lead to J_EPD; 16 x M3 frame screws with the GND ring pads; XH leads from J_X1202SW and J_PIJ2"),
    ...
    ("meshsat-pcb-e2-revA-E3", "pcb-e2-rfjunction", "pcb-e2-rfjunction", "PCB-E2 RF JUNCTION", "E3", "bare board, no assembly: seven Amphenol Connex 132170 SMA female-female bulkhead couplers in the D-holes (6.5 mm with the flat at 6.00 across, 8 mm hex nut and lock washer on the cavity side, appendix 32.10) (UHF SDR WIFI1 WIFI2 LTE IRID LORA), six M3 into the 1520 +Z wall drill points"),
]
