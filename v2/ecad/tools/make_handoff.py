...
BOARDS = [  # (deliverable folder, file stem, project dir, title, phase, hand-fitted list)
    ...
    ("meshsat-pcb-c-revA-C17", "pcb-c-display", "pcb-c-display", "PCB-C PANEL BACKER", "C17", "C17 is the backer ring under the 3 mm aluminium face plate of the Peli 1450 (appendix 32.56, 32.60, 32.61; the plate set is in release/revA/case/face-plate/): 344 x 228 with a 240 x 176 void, four layers, hanging 10 mm under the plate on eight PEM SO-M3-10 standoffs (M3 x 6 through H1 to H8, the ground bond to the plate). It carries the RP2040 panel controller (a USB device on the panel ribbon), the two PCA9555, the PDi E2370KS0C1 e-paper ZIF and boost stage, the VEML7700, the sounder driver and the sixteen 3 mm LEDs standing on the top face under the plate's Mentor 1282.5004 light guides (bench-soldered, beaded to height). The switches, the sounder, the two U-174/U headset jacks and the camera module mount in the PLATE and only their leads reach the board: SW_MAIN C&K ATP19-SL1-603-B0SA-03G, SW_PI C&K ATP16-SL1-403-M0SA-04G, SW_TEST C&K ATP16-SL1-203-M0SA-04G, SW_LIGHT NKK M2044SD3A01, SW_SOS, SW_EMCON and SW_ZERO APEM 5636ADKB-2V, BZ1 Floyd Bell MC-09-530-Q; the Xenarc 709GNK sits in the plate with its glass level with the face and its body passes the ring's notch. C17 is the phase that ships (15 September 2026, appendix 32.192), the first C deliverable: 0 hard, 0 unrouted, check_pcb_c ALL PASS, the 5 V rail MET, netlist_board 852 of 852, contracts ALL PASS, verify_deliverable 36 of 36; its test points stand beside the nets they probe; its only pair, the RP2040's full-speed USB, is declared with no impedance target (appendix 32.79), so no impedance control is asked of the fab for this board."),
...
PCB_OPTIONS = {"pcb-a-power": ["FABRICATION NOTES (A24, the power board on the six-layer stack, appendix 32.55, 32.61, 32.145)",
    ...
    "pcb-c-display": ["FABRICATION NOTES (C17, the backer ring under the aluminium face plate, appendix 32.60, 32.192)",
