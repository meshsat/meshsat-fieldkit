...
PCB_OPTIONS = {"pcb-a-power": ["FABRICATION NOTES (A22, the power board on the six-layer stack, appendix 32.55, 32.61)",
    ...
    "pcb-p-pack": ["FABRICATION NOTES (P1, the pack BMS board, appendix 32.62)",
