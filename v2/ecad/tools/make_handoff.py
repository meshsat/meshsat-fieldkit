...
BOARDS = [  # (deliverable folder, file stem, project dir, title, phase, hand-fitted list)
    ...
    ("meshsat-pcb-e2-revA-E3", "pcb-e2-rfjunction", "pcb-e2-rfjunction", "PCB-E2 RF JUNCTION", "E3", "bare board, no assembly: seven SMA female-female bulkhead couplers in the D-holes (UHF SDR WIFI1 WIFI2 LTE IRID LORA), six M3 into the 1520 +Z wall drill points"),
]
