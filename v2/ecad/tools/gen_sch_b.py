...
def slot(s):
    ...
    part("J_FAN%d" % s, "Connector_Generic", "Conn_01x04", "IP68 cooler fan of S%d (JST-SH 1.0): 5V GND TACHO PWM" % s, "SH4", {"1": n5, "2": "GND", "3": "FAN_TACHO%d" % s, "4": "FAN_PWM%d" % s}, "C160390"); r(R(51), "10k", "FAN_PWM%d" % s, cm33)   # J_FAN: JST BM04B-SRSS-TB(LF)(SN), the part this line names (JLCPCB stock 70,953 on 14 Sep 2026). R151/R251/R351: the fan PWM pull-up, swallowed by this comment 14 to 15 Sep 2026 (test_swallowed_calls)
...
def layout(page_h):
    ...
    return x + COLW
max_x = layout(800.0); PAPER = kisch.reband(out, page_h=800.0)   # 15 Sep 2026: bands under a page that holds the drawing (32.194)
