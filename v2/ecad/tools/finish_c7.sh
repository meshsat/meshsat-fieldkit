...
if ! python3 ../tools/check_pcb_c.py $N.kicad_pcb 2>/dev/null | grep -q 'RESULT: ALL PASS'; then echo 'C7 GATE FAIL on the routed board'; echo open > out/c7-clean.txt; fi
