...
text("E5 BLOCK  face 7.4 mm", -134.0, -61.0, pcbnew.F_SilkS, 0.9, 0.15); text("A20 pins land here", -128.5, -61.5, pcbnew.B_SilkS, 0.9, 0.15, mirror=True)   # inside the edge (Y1 -59), clear of the corner hole and the wire hole rings
