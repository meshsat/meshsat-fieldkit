...
FIXED = {"J_HARN1": (-42, 8, 0, False), "J_PWR1": (-42, -16, 90, False), "J_HS1": (46.5, 12, 90, False), "J_HS2": (46.5, -12, 90, False), "J_USB3": (46, 24, 90, False),
         ...
         "R12": (21.6, 6.3, 270, False), "R13": (20.0, 6.3, 270, False), "R16": (24.8, 6.3, 270, False), "R17": (23.2, 6.3, 270, False),   # pad 1 (the hub side) north, pad 2 (the pair) south
...
if os.path.exists(pro):
    ...
    d.setdefault("net_settings", {})["classes"] = [C("Default", 2147483647, 0.127, 0.25, 0.6, 0.3), C("PWR", 0, 0.127, 0.5, 0.8, 0.4), C("RF", 1, 0.3, 0.35, 0.6, 0.3), C("USB", 2, 0.127, 0.2, 0.6, 0.3)]
