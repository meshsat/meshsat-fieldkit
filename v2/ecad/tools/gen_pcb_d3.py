...
CLASSES = {"USB": (0.14, 0.2, 0.7, 0.3, 0.2, 0.15), "PWR": (0.14, 0.4, 0.8, 0.4, 0.4, 0.25), "CELL": (0.15, 0.8, 1.0, 0.5, 0.8, 0.3)}   # CELL: the 5 A boost loop
...
if os.path.exists(pro):
    ...
    d.setdefault("net_settings", {})["classes"] = [C("Default", 2147483647, 0.14, 0.25, 0.7, 0.3, 0.2, 0.15), C("USB", 0, 0.14, 0.2, 0.7, 0.3, 0.2, 0.15), C("PWR", 1, 0.14, 0.4, 0.8, 0.4, 0.4, 0.25), C("CELL", 2, 0.15, 0.8, 1.0, 0.5, 0.8, 0.3)]
