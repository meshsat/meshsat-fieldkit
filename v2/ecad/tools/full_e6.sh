...
python3 ../tools/prefanout.py $N.kicad_pcb 'GND,CELL_F,VIN_RAW,PV_P,TRK_OUT' fine   # only nets with a plane or pour to land on (7 Sep 2026: a pre-placed via of a net without a plane is one more open for the router) 2>&1 | grep -E 'fanout:'
