...
RULES = {
 ...
 "b": [("J_PANEL ribbon up to PCB-C", dict(pos=(86, 75.5), angle=0)),
       ...
       ("GEEKWORM X1202 V1.1 (96 x 85)", dict(text="X1202 V1.1 96x85 + Pi 5 + cooler on 4x M2.5x22 (49x58); Pi HDMI edge WEST, header edge EAST, SD card SOUTH", pos=(-69, 40.0), size=0.9)),
       ("cells hang under the whole X1202", dict(text="NO PART under the X1202 (cells at board level); DC jack NE corner faces +X; USB-A sockets overhang south 9 mm", pos=(-69, -40.0), size=0.9))],
