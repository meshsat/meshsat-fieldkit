...
FIXED = {"J_5V_IN1": (-92, -58, 0), "J_5V_IN2": (-92, -68, 0), "J_TD2": (-50, 77, 0), "J_USB_UP1": (-30, -78, 180), "J_USB_UP2": (30, -78, 180),
...
REGIONS = [
 ...
 ("SDR",  (-22, -19, -4.5, -9.5), ["U4", "U5", "U6"]),
 ("SDR2", (-22, 9.5, -5, 16.5), ["R13", "R30", "C33", "R14", "C12", "C13"]),
 ("ZB",   (46, 58.5, 78, 84), ["U7", "R15", "R31", "C34", "R16", "U8", "C14", "C15", "U9"]),
 ("TC",   (-22, 17, 0.5, 40.5), ["F2", "U15", "C20", "C31", "R34", "R22", "U16", "C21", "C22", "U17"]),
 ("XIAO", (-70, 50, -42, 73), ["F4", "U10", "C27", "C29", "R32", "R17", "R18", "U11", "C16", "C17", "U12"]),
 ("RB",   (-20, -40, 15, -19.5), ["F5", "U13", "C28", "C30", "R33", "R20", "R21", "U14", "C18", "C19", "JP3", "JP4", "Q1", "R26", "R27", "R28"]),
 ("DCF",  (-72, 74, -60, 80), ["R29"]),
]
