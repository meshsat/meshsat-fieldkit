...
for s in (1, 2, 3):
    ...
    # OWNER RULING 13, 13 September 2026: B's region rectangles are released to this session, board B
    # only, one at a time and each reported with its overflow before and after. At the 2.6 mm fine-pitch
    # margin (PLACE_FINE_MARGIN, the experiment ruling 18 asks for) NINE regions overflow, worst 8.4 mm, and
    # the packer puts what does not fit OUTSIDE the rectangle on top of whatever is there. Before and after:
    #   S1_SWIC 8.4 mm over -> north, -20 to -8. The band y -20..32 in that column holds no region at all.
    #   S2_SWIC 5.7 mm over -> north to -8 AND east 10 to -3, because S2_SUP2 starts at x -3.
    #   S3_SWIC 3.7 mm over -> north with S1, the same formula.
...
REGIONS += [
 ...
 ("ETH",   (-162, 3, -122, 59), ["U1", "Y1", "C14", "C15", "R3", "R57"] + ["C%d" % k for k in range(17, 29)], False),
 ...
 ("GAP12", (-50, 25, -32, 97), ["U6", "U7", "U19", "U20", "U29", "U37", "C65", "C66", "C67", "C68", "R49", "R50", "R51", "R52", "R53", "R58", "R59", "R60", "R61", "R62", "R54", "R55", "R56", "F1", "R5", "R6", "R7", "R8", "LED1", "LED2", "LED3", "LED4", "Q2", "R4", "C16"], False),
 ...
 ("RADE",  (125.5, 41.5, 162, 74), ["R25", "R28", "R29", "R30", "R31", "R32", "R33", "R34", "R35", "J_ZBDBG1", "J_ZBDBG2", "J_LORA1", "U28", "U34", "J_CAM"], False),
