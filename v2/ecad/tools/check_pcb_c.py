...
import verdict as _vh; _vh.crash_hook("check_pcb_c", sys.argv[1:])   # a crash in this module body writes INCONCLUSIVE, never nothing (18 Sep 2026)
...
_sysv.exit(_v.write("check_pcb_c",
