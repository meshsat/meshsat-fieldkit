...
FIXED = {"J_AB1": (113, -46, 0), "J_MEZZ_PWR1": (-8, -18, 90),
         ...
         "Q10": (-115.975, 27.0, 0), "Q9": (-108.585, 27.0, 0), "L2": (-101.02, 26.3, 0), "Q8": (-93.845, 27.0, 0), "Q7": (-86.455, 27.0, 0),   # 20 Sep 2026: TI layout item 6, the inductor BETWEEN the power-stage pairs; the row is packed east to west from R16 with every courtyard 0.20 mm apart
         "R16": (-78.59, 27.44, 0), "R17": (-113.55, 20.69, 0),   # unchanged seats, FIXED so the packer cannot take them back
         "C24": (-106.5, 20.7, 0), "C25": (-100.5, 20.7, 0), "C23": (-94.5, 20.7, 0),   # CH_SRP, beside Q10 and R17; 1.1 mm lower than 05:35 so L2's own courtyard clears them
...
("CHQ",   (-119.5, 18.5, -70, 30), []),   # 20 Sep 2026: every part of this block is FIXED in the converter's order above, because a row packed BY SIZE is what put the shunts at the wrong ends; the west edge went -118 to -119.5 for TI item 6, into a strip where nothing stands and the board's own edge is 2.05 mm further west
