...
FLAG_READS = 70   # 71 until 19 September 2026, when hardset.py took verdict.opt: it is the instrument
                  # every board gate and every guard reads its counts from, and `--score` with nothing
                  # after it raised IndexError inside it. The number only ever comes down.
