...
# THE BARREL COUNT AT A RAIL'S OWN CROSSING IS `rail_crossings.py` AND IT RUNS LATER (18 September
# 2026). It was printed here first, and on board E's E20 generation it named SEVEN crossings that the
# stages after this one had already answered: the ground grid lays 1,829 vias after the fanout and the
# escapes lay more, so a report at this point names sites somebody else fixes ten seconds later. The
# chain asks the same question of the FINISHED placement instead.
