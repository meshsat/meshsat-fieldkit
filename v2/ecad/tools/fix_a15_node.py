#!/usr/bin/env python3
"""A16 pack node bars on top of the routed board, with a crossing check against every existing track of another net on the chosen layer.
...
Usage: fix_a15_node.py <board.kicad_pcb>"""
import sys, pcbnew
