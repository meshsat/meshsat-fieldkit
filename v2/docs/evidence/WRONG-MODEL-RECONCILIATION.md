...
| round-6 candidates, not merged, read for their direction only | A `wt/r4a/drafts/box/fixup3-run2/repo/pcb-a-power.net` daf132b22fad9854 (14:05; rebuilt by command N4 of `v2/docs/records/README.md`), B `wt/r4b/drafts/box/r6-run6/tint/regen/pcb-b-compute.net` af8a9186f981210c (13:18; rebuilt by command N1 of `v2/docs/records/README.md`), D `wt/r6d/drafts/box/rf002/new/pcb-d-aprs.net` 9aae5bf93a104abc (14:13; filed as `v2/docs/records/rv-emc/netlists/D-r6cand-pcb-d-aprs.net`) | the same match |
