...
- Case: the connector plate with its two receptacles (section 4) on the back wall, and the seven Amphenol Connex 132170 SMA couplers in the end walls (D-holes, 8 mm nut and lock washer inside, O-ring outside), all per `release/revA/case/wall-receptacles-1to1.pdf`.
