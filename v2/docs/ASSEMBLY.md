...
|---|---|---|---|
| Rod stack, 4 x | M3 stainless threaded rod, floor to the top nut above PCB-B; spacer tubes on the dock strip that set the 13.4 mm blind-mate gap under PCB-A; 38 mm (35 mm before D7) and 59 mm bay spacers | 0.5 N m | Nyloc nuts top and bottom, no threadlocker on Nyloc |
