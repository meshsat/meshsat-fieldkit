...
| PWR-001 every rail is declared with its loads | BLOCKER | SCHEMATIC | **FAIL** | intent_checks FAIL: {'fail': 1, 'pass': 159} |
| DEC-001 decoupling loop area | MUST_JUSTIFY | PLACED_BOARD | **FAIL** | intent_checks FAIL: {'fail': 1, 'pass': 159} |
...
| RET-002 plane-adjacency screen | MUST_JUSTIFY | ROUTED_BOARD | **FAIL** | intent_checks FAIL: {'fail': 1, 'pass': 159} |
...
| RET-004 ground-via proximity screen | MUST_JUSTIFY | ROUTED_BOARD | **FAIL** | return_via FAIL: {'exempt': 16, 'judged': 20, 'lacking': 15, 'same_plane': 13, 'slow': 115} |
...
| PAIR-001 a pair is coupled and matched | BLOCKER | ROUTED_BOARD | **PASS** | impedance_check PASS of 4 |
...
| MEC-001 the board fits what it is fitted to | BLOCKER | PLACED_BOARD | **FAIL** | check_pcb_d FAIL: {'fail': 1, 'footprints': 211, 'pass': 327} |
