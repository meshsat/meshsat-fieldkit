...
| | P50 | P80 |
|---|---|---|
| engineering effort, one worker | 81 h | 254 h |
| the same at 6 hours a day | 13.5 days | 42.3 days |
...
|---|---|---|---|---|
| PARALLEL_AGENT | 13 | 65 h | 208 h | session work with no shared file, so several may run at once in their own worktrees |
...
| | P50 | P80 |
|---|---|---|
| session pool | 11.5 days | 36.7 days |
| fleet pool | 0.2 days | 0.7 days |
| longest dependency chain | 3.2 days | 12.0 days |
| **design package ready for prototype** | **11.5 days** | **36.7 days** |

## The programme, cumulative elapsed days from the day this page was generated

| milestone | P50 | P80 | where the number comes from |
|---|---|---|---|
| DESIGN_PACKAGE_READY_FOR_PROTOTYPE | 12 days | 37 days | COMPUTED |
| FABRICATION_AND_ASSEMBLY | 24 days | 67 days | VENDOR_PUBLISHED |
| BENCH_BRING_UP | 38 days | 112 days | DECLARED_ESTIMATE |
| LAB_VALIDATION | 58 days | 202 days | DECLARED_ESTIMATE |
| PRODUCTION_RELEASE_READY | 88 days | 322 days | DECLARED_ESTIMATE |
