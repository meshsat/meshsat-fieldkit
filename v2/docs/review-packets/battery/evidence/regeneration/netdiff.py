#!/usr/bin/env python3
"""Semantic difference of two KiCad s-expression netlists (round 4 board P, 26 September 2026; copied unchanged from wt/r4p/drafts/scripts/netdiff.py for review stream BAT).
