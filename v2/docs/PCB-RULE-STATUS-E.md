...
| PWR-001 every rail is declared with its loads | BLOCKER | SCHEMATIC | **FAIL** | intent_checks FAIL: {'fail': 24, 'pass': 74} |
...
| DEC-001 decoupling loop area | MUST_JUSTIFY | PLACED_BOARD | **FAIL** | intent_checks FAIL: {'fail': 24, 'pass': 74} |
...
| RET-002 plane-adjacency screen | MUST_JUSTIFY | ROUTED_BOARD | **FAIL** | intent_checks FAIL: {'fail': 24, 'pass': 74} |
...
| MEC-001 the board fits what it is fitted to | BLOCKER | PLACED_BOARD | **FAIL** | check_pcb_e FAIL: {'fail': 24, 'footprints': 189, 'pass': 143} |
