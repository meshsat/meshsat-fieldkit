...
| DEC-001 decoupling loop area | MUST_JUSTIFY | PLACED_BOARD | **FAIL** | intent_checks FAIL: {'fail': 4, 'pass': 236} |
...
| PI-002 rail voltage drop | BLOCKER | ROUTED_BOARD | **FAIL** | dc_drop FAIL: {'met': 8, 'missed': 4, 'undeclared': 0} |
...
| RET-002 plane-adjacency screen | MUST_JUSTIFY | ROUTED_BOARD | **FAIL** | intent_checks FAIL: {'fail': 4, 'pass': 236} |
...
| RET-004 ground-via proximity screen | MUST_JUSTIFY | ROUTED_BOARD | **FAIL** | return_via FAIL: {'exempt': 54, 'judged': 167, 'lacking': 117, 'same_plane': 68} |
...
| MEC-001 the board fits what it is fitted to | BLOCKER | PLACED_BOARD | **FAIL** | check_pcb_a FAIL: {'fail': 5, 'footprints': 400, 'pass': 1047} |
