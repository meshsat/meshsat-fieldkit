...
- Power pin block on the underside at about X -50 to -30, Y -74 to -64: four plus four Mill-Max 0858 class 9 A pins (pack + and return) beside J_DOCK's signal pins, landing on the dock's raised block. The return passes the gauge shunt (5 mOhm 2512, Kelvin) before it reaches GND; every ampere in or out of the module crosses it.
...
**South band, the seven blind-mate sites:** Radiall R222M00720 receptacles on the underside at Y -66, X = -150, -130, -110, 8, 24, 40, 108, each with a vertical SMA jack (Amphenol 132134 class) on the top face 10 mm north of it, joined by a short 50 ohm trace on the bottom layer over an In2 ground island stitched to In1 (the In2 module-rail plane is cut out under each site). The dock strip grows west to carry the three western float clamps (MESHSAT-790). Path assignment from west to east: UHF (mezzanine), WiFi 2.4, WiFi 5.8, SDR, LTE, Iridium, LoRa; the module pigtails from PCB-B come down the stack's east edge.
