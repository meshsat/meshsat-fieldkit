...
**One question is still open**: the 2.5 A polyfuse on A19 feeds the heating pad from SHORE_12V, and the part found for it is rated 16 V while the clamp on that rail lets through about 24 V. A part rated 30 V or more is being sourced.
