...
**Dock strip E4 and block E5, in progress.** Strip 285 x 60 with the seven float clamps, the block standoffs, the converter under the gap, the ideal-diode entry, the LT8705A tracker and the module entry at the west end; four placement passes to a clean gate; routing running. The block board generates (17 footprints, 9 nets).
