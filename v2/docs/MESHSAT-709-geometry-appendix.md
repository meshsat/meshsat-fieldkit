...
4. **The display shows the MeshSat touchscreen** (the owner's screenshot of 6 Sep 15:14 UTC from the tesseract kit, 1280 x 720, now `v2/cad/render/ui.png`). The sixth set still rendered the display black: the textured screen object sat 0.5 mm inside the display body, under its opaque glass, since the first 1450 set; the seventh set (18:15, 6bca935) has it on the glass and the dashboard shows in every face view.
