...
|---|---|---|---|---|---|---|---|
| A22 POWER (6L, 3313 stack, 0.25 via) | Y25-11651261A, 8-9 days | 135.25 | SMT026090860345, top, 5-6 days | 1131.75 | top | 129: 127 / 1 (C1,C2 100u 25V C2911627 0 stock) / 1 unmatched (C11 group 22u 50V X7R 1210 C55533070 pre-order) | laptop session; at 12:11 the cart flagged its L1 XAL1010-103MED C6358489 as out of stock (1 left) and greys the two Y25 lines out of the selection; see the A22 note below |
