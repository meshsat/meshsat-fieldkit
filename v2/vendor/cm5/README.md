...
The CM5 IO Board design files are published by Raspberry Pi Ltd for reuse in carrier designs; the footprint of the two connectors in `meshsat.pretty/CM5_Amphenol_10164227.kicad_mod` is derived from them.
