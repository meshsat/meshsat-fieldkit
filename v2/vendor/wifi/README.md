...
| (product page only: asiarf.com/product/wifi-6-mini-pcie-module-1800mbps-aw7915-npd-2x/) | asiarf.com | AW7915-NPD-2X, the same chip on mini PCIe, 2 x MMCX, 50.95 x 30 mm, FCC and CE stated (IDs on request), USD 28; its datasheet link returned an error page on 5 Sep 2026 |
...
**Ruling 5 Sep 2026 05:45 (owner):** the card is the **AsiaRF AW7915-AED** (M.2 A/E-key) on an M.2 E-key socket of the PCB-B respin B14, two IPEX leads to two SMA bulkheads; the certification numbers are requested from AsiaRF sales before the order.
